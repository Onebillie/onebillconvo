  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "Bring WhatsApp Business API, email, SMS, Instagram and AI into one powerful inbox. Trusted by 1,000+ businesses worldwide."
      );
    }
  }, []);
      ...
      <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-background/80">
        <nav className="max-w-[1200px] mx-auto px-5 py-4 flex items-center gap-7">
          ...
          <Button
            ...
            className="rounded-full bg-primary text-primary-foreground hover:bg-primary/90 font-bold px-6"
          >
      ...
      <section className="relative min-h-screen flex items-center justify-center text-center px-6">
        <div className="mt-16 max-w-[1100px] relative z-10">
          ...
          <Button
            ...
            className="mt-7 px-8 py-6 text-base rounded-xl bg-accent text-accent-foreground hover:bg-accent/90 font-bold shadow-lg"
          >
      ...
      <section className="bg-card py-20 text-center" id="features">
        ...
        <div className="overflow-hidden mask-marquee">
          <div className="flex gap-4 animate-marquee">
            {["WhatsApp Business", "SMS", "Email", "Instagram DMs", "Facebook Messenger", "Website Widget", "Voice & Files", "Team & Tasks", "AI Assistant", "Developer API"].map((item, i) => (
              <div key={i} className="min-w-[240px] px-6 py-9 rounded-2xl bg-primary text-primary-foreground font-bold text-center shadow-md">
                {item}
              </div>
            ))}
            {["WhatsApp Business", "SMS", "Email", "Instagram DMs", "Facebook Messenger", "Website Widget", "Voice & Files", "Team & Tasks", "AI Assistant", "Developer API"].map((item, i) => (
              <div key={`dup-${i}`} className="min-w-[240px] px-6 py-9 rounded-2xl bg-primary text-primary-foreground font-bold text-center shadow-md">
                {item}
              </div>
            ))}
          </div>
