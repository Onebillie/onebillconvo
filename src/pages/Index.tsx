  ...
  return <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <Button size="lg" onClick={() => navigate('/onebillchat/dashboard')} className="text-lg px-8 py-6">
            Go to Dashboard
          </Button>
        </div>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 max-w-4xl mx-auto">
          ...
          <div className="text-center p-6 rounded-lg border border-border">
            ...
            <p className="text-gray-950">Role-based authentication ensures only authorised agents can access</p>
          </div>
        </div>
      </div>
    </div>;
